    ...
    "Pytest-benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "url": "https://github.com/danielorihuela/SyMPC/commit/090c11dbefbebaab160c6480ade2d3df120715a1"
        },
        "date": 1627548807499,
        "tool": "pytest",
        "benches": [
          {
            "name": "benchmarks/module/module_benchmark_test.py::test_run_inference_conv_model",
            "value": 0.4825789307141462,
            "unit": "iter/sec",
            "range": "stddev: 0.03796470800837547",
            "extra": "mean: 2.0721998751999933 sec\nrounds: 5"
          }
        ]
      },
      {
        "commit": {
          ...
          "url": "https://github.com/danielorihuela/SyMPC/commit/af178dbc99cd1077871346113a4a05abbb510ffc"
        },
        "date": 1627740390343,
        "tool": "pytest",
        "benches": [
